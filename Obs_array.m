function P_obs=Obs_array(node_x,node_y,xTarget,yTarget,CLOSED,Nobs) % , P_tong
  ...
  node_obs=0;
   for a=1:1:Nobs
      x_obn=CLOSED(a,1); y_obn=CLOSED(a,2); %%ÅĞ¶ÏÕÏ°­µãÊÇ·ñÔÚĞĞÊ»ÇøÓòÄÚ
  ...
  if  node_obs~=0
      ...
      P_obs = 0.001;  % ·ÀÖ¹log(0)=-Infµ¼ÖÂA*Ê§°Ü
  end
%    num_i=0;
% 
%  
